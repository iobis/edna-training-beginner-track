...
library(Biostrings)
#remotes::install_github("obistools")
library(obistools)
...
You'll notice we are also creating an `eventID` string by concatenating information about the date, location, and sample name. See the [OBIS Manual](https://manual.obis.org/identifiers.html) for more details about constructing identifiers.
